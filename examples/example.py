import pyfmgng.client
import pyfmgng.adom
from pyfmgng.fmgapi import FmgAPIObjectExists, FmgApiObjectNotFound
...
client = pyfmgng.client.FmgClient(fmg_host,fmg_username, fmg_password,adom_name)
